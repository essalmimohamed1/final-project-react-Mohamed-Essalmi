...
export const FirstSectionAddcart = () => {
    ...
    return (
        <div className='w-full min-h-screen bg-black flex flex-col items-center pb-10 text-white'>  
            {/* Cart Items */}
            <div className='w-[90vw] lg:w-[80vw] bg-gray-900 shadow-lg rounded-lg mt-5 p-5'>
                <div className='grid grid-cols-2 sm:grid-cols-5 gap-4 border-b-2 p-2 text-center border-green-600'>
                ...
                {basket.length > 0 ? basket.map((element, index) => (
                    <div className='grid grid-cols-2 sm:grid-cols-5 gap-4 items-center p-5 border-b-2 border-green-600' key={index}>
                        ...
                        <div className='col-span-1 text-center'>
                            <div className='flex items-center justify-center gap-2'>
                                <button onClick={() => updateQuantity(index, 1)} className='bg-green-600 text-white px-3 py-1 rounded-full hover:bg-green-700 transition-all'>
                                    +
                                </button>
            ...
            {/* Cart Total */}
            <div className='w-[90vw] lg:w-[30vw] bg-gray-900 shadow-lg rounded-lg mt-10 p-5'>
