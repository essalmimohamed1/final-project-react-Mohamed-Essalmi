            ...
            <div className='lg:flex flex lg:flex-row flex-col p-10'>
                ...
                <div className='flex flex-col gap-6 p-6    '>
                    ...
                    <div className='flex flex-col gap-6'>
                        ...
                        <button className='bg-zinc-900 text-white lg:h-[7vh] lg:w-[40vw] h-[8vh] w-[50vw] font-light text-2xl rounded-3xl hover:bg-orange-600 hover:transition-all'>SEND</button>
                    </div>
                </div>
            </div>
        </>
